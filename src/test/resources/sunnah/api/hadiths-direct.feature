Feature: Test Hadiths Endpoints (Direct API Calls)
  ...
  Scenario Outline: Test GET /collections/{collectionName}/hadiths/{hadithNumber} endpoint
    # Log test info
    * print 'Testing endpoint: /collections/' + collectionName + '/hadiths/' + hadithNumber
    
    # API1 call
    * def api1Url = apiImpl1.baseUrl + '/collections/' + collectionName + '/hadiths/' + hadithNumber
    ...
    * print 'API1 response status:', response.status
    ...
    # API2 call
    * def api2Url = apiImpl2.baseUrl + '/collections/' + collectionName + '/hadiths/' + hadithNumber
    ...
    * if (isApi2Working) 
      ...
      * def endpoint = '/collections/' + collectionName + '/hadiths/' + hadithNumber
